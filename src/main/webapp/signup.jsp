...
<body>
  ...
  pattern="[0-9]{10}" title="10 digit number is allowed note: only numbers are allowed "><br><br>
            </div>
  ...
  pattern="[0-9]{12}" title="12 digit number note: only numbers are allowed "><br><br>
            </div>
  ...
  pattern="[0-9]{6}" title="6 digit pin code note: only numbers are allowed "><br><br>
            </div>
